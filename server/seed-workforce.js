...
const seedWorkforceData = async () => {
  try {
    ...
    // 2. Create Sample Workers & Users
    const sampleWorkersData = [
      {
        name: 'Ramesh Kumaar',
        email: 'ramesh.worker@cardora.com',
        workerId: 'WRK-1001',
        gender: 'Male',
        age: 32,
        district: 'Idukki',
        ...
        experience: '8 Years Cardamom Picking',
        skills: ['Capsule Harvesting', 'Drip Irrigation', 'Weed Control', 'Soil Fertilization'],
        specializations: ['High Altitude Capsule Harvesting', 'Organic Spraying'],
        dailyWage: 900,
        availability: 'Available Today',
        rating: 4.9,
        completedJobs: 42,
        photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400',
        bio: 'Expert cardamom harvester with 8+ years experience in high-yielding plots across Vandanmedu & Kattappana.',
      },
      {
        name: 'Anitha Selvam',
        email: 'anitha.worker@cardora.com',
        workerId: 'WRK-1002',
        gender: 'Female',
        age: 29,
        district: 'Idukki',
        ...
        experience: '6 Years Sorting & Harvesting',
        skills: ['Selective Capsule Picking', 'Post-Harvest Sorting', 'Capsule Washing'],
        specializations: ['Grade-A Capsule Selection', 'Moisture Checking'],
        dailyWage: 850,
        availability: 'Available Today',
        rating: 4.8,
        completedJobs: 38,
        photo: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400',
        bio: 'Specialist in grade-A cardamom sorting and green capsule hand-picking.',
      },
      {
        name: 'Suresh Joseph',
        email: 'suresh.worker@cardora.com',
        workerId: 'WRK-1003',
        gender: 'Male',
        age: 36,
        district: 'Wayanad',
        village: 'Meppadi',
        phone: '+91 98473 55667',
        languages: ['Malayalam', 'English'],
        experience: '10 Years Heavy Machinery & Pruning',
        skills: ['Shade Tree Pruning', 'Spraying', 'Soil Pit Digging', 'Trench Maintenance'],
        specializations: ['Shade Management', 'Fungal Spraying'],
        dailyWage: 1050,
        availability: 'Available Next Week',
        rating: 5.0,
        completedJobs: 56,
        photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=400',
        bio: 'Certified shade management specialist for high-canopy cardamom estates.',
      },
      {
        name: 'Devi P.',
        email: 'devi.worker@cardora.com',
        workerId: 'WRK-1004',
        gender: 'Female',
        age: 27,
        district: 'Idukki',
        village: 'Kumily',
        phone: '+91 98474 77889',
        languages: ['Malayalam', 'Tamil'],
        experience: '4 Years Cardamom Nursery & Harvesting',
        skills: ['Nursery Management', 'Sapling Planting', 'Weeding', 'Capsule Harvesting'],
        specializations: ['Organic Nursery Development'],
        dailyWage: 800,
        availability: 'Available Today',
        rating: 4.7,
        completedJobs: 24,
        photo: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=400',
        bio: 'Dedicated nursery specialist and organic fertilizer application worker.',
      },
    ];
    ...
    for (const w of sampleWorkersData) {
      let u = await User.findOne({ email: w.email });
      if (!u) {
        u = await User.create({
          name: w.name,
          username: w.email.split('@')[0],
          email: w.email,
          password: 'password123',
          role: 'Worker',
          phone: w.phone,
          location: `${w.village}, ${w.district}`,
          district: w.district,
          bio: w.bio,
          avatar: w.photo,
          isVerified: true,
      ...
      createdWorkerUsers.push(u);

      let workerProf = await Worker.findOne({ user: u._id });
      if (!workerProf) {
        await Worker.create({
          user: u._id,
          workerId: w.workerId,
